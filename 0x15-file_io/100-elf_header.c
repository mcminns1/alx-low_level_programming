...
* @e_ident: a pointer to an array containing the ELF magic numbers
* Description: magic numbers are separated by spaced
*/
...
/**
* print_data - prints the date of an ELF header
...
/**
* print_abi - prrints the ABI version of an ELF header
...
* @e_ident: a pointer to an array contaning the ELF class
*/
