...
/**
 * print_class - prints the class of an ELF headers
...
void print_data(unsigned char *e_ident)
{
	...
	case ELFDATA2LSB:
		...
		break;
	case ELFDATA2MSB:
		printf("2's comlement, big endian\n");
		break;
	default:
		printf("<unknown: %x>\n", e_ident[EI_CLASS]);
	}
 ...
 * Description: if the file cannot be closed - exit code 89
 */
